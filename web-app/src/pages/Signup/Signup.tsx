    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-primary)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        <div style={{ width: '100%', maxWidth: '400px' }}>
          <h2 style={{ fontSize: '1.8rem', marginBottom: '0.5rem', color: 'var(--text-primary)' }}>Create Account</h2>
          <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem' }}>Start your reading journey today.</p>

          <div style={{ display: 'flex', background: 'var(--bg-secondary)', borderRadius: '8px', padding: '4px', marginBottom: '2rem' }}>
            <Link to="/login" style={{ flex: 1, textAlign: 'center', padding: '0.75rem', color: 'var(--text-secondary)', fontWeight: 500, textDecoration: 'none' }}>Login</Link>
            <Link to="/signup" style={{ flex: 1, textAlign: 'center', padding: '0.75rem', background: 'var(--bg-primary)', borderRadius: '6px', color: 'var(--accent-primary)', fontWeight: 500, textDecoration: 'none' }}>Sign Up</Link>
          </div>
